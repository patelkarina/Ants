...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if hasattr(insect, "queen") and insect.queen == True:
                return 
            # END Problem 13
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        if self.container == True and not self.ant and not other.container:
                return True
        return False 
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        for x in range(self.min_range):
            newplace = newplace.entrance
        while newplace != None and newplace != hive and count <= self.max_range:
            if random_or_none(newplace.bees) != None:
                return random_or_none(newplace.bees)
            newplace = newplace.entrance
            count += 1
        return None 
        # END Problem 3 and 4
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.value != 0:
            ...
            while newplace.exit != None:
                if newplace.exit.ant not in self.ants_x:
                    newplace.exit.ant.damage *= 2
                    self.ants_x = self.ants_x + [newplace.exit.ant]
                if newplace.exit.ant and newplace.exit.ant.container and newplace.exit.ant.ant not in self.ants_x:
                    newplace.exit.ant.ant.damage *= 2
                    self.ants_x = [newplace.exit.ant.ant] + self.ants_x
                newplace = newplace.exit
